...
import { Calendar, Map, Tag, LogOut, Home, ShieldCheck, MessageSquare, HelpCircle, BarChart3, MessageCircleQuestion, Handshake, Camera, Settings } from "lucide-react";
...
const tabs = [
  ...
  { to: "/admin/photos", label: "Photos", icon: Camera, end: false },
